...
enum ParseChar		//Enumeration 
{
   ...
   // -- This x is to avoid the collision with the ASCII codes of regular keys
   ...
   //    HOME END don't have DUMMY KEY
   //
   MOD_KEY_FLAG     = 1 << 9,
   MOD_KEY_INT      = 91,
   HOME_KEY         = 18,//ctrl-r 72 + MOD_KEY_FLAG,
   INSERT_KEY       = 50 + MOD_KEY_FLAG,
   DELETE_KEY       = 51 + MOD_KEY_FLAG,
   END_KEY          = 6,//ctrl+f 70 + MOD_KEY_FLAG,
